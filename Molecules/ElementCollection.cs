...
/// </summary>
public sealed record ElementCollection : ICollection<Element>
{
    /// <summary>
    /// Backing collection.
    /// </summary>
    ...
    /// </summary>
    private readonly Dictionary<int, Element> _elementsByAtomicNumber = [];

    /// <summary>
    /// Used for more performant lookups by symbol.
    /// </summary>
    private readonly Dictionary<string, Element> _elementsBySymbol = [];
    ...
    /// </summary>
    public static ElementCollection PeriodicTable { get; } =
    [
        Element.H,
        Element.He,
        Element.Li,
